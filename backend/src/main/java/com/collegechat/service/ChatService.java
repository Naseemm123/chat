...
public class ChatService {
    ...
    // sessionId -> clientId generated by frontend browser tab
     ...
     */
    public void connectUser(WebSocketSession session, String username, String roomId, String clientId) {
    ...
    public void handleChatMessage(WebSocketSession session, ChatMessage message) {
        ...
        message.setSenderClientId(sessionToClientId.get(session.getId()));
